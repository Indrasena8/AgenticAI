...
HACKATHONS_FOLDER = "/Users/indrasena/Indrasena/Studies/CS/Semester4/Agentic AI/AgenticAI/hackathons"
...
def request_postevent_summary(event_filename):
    """Send a request to agent including the selected hackathon JSON file content."""

    # First, read the file content
    file_path = os.path.join(HACKATHONS_FOLDER, event_filename)
    try:
    ...
    # Now properly include the file content inside the prompt
    message_content = f"""
The following is the event data extracted from the file `{event_filename}`:

{file_content}

👉 Please generate a complete Post-Event Summary based on this data.
Format nicely for organizers.
"""
